...
<body class="text-gray-800">
    <!--sidenav -->
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f3f3f8] p-4 z-50 sidebar-menu transition-transform">
        <a href="/" class="flex items-center">
            <img src="{{ asset('/images/logo.png') }}" class="h-6 mr-2 sm:h-9" alt="Wellbeacon Logo" />
            <span class="self-center text-xl font-black text-gray-900 whitespace-nowrap">Wellbeacon™</span>
        </a>
        <ul class="mt-4">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        <!-- navbar -->
        <div class="py-2 px-6 bg-[#f3f3f8] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
