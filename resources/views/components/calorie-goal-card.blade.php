    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div class="p-6 relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
                ...
                <form action="#" method="POST" class="flex max-w-xs mx-auto  justify-start">
                    @csrf
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <input type="number" id="calorie_goal" name="calorie_goal"
                                class="form-input flex-grow rounded-l-md" placeholder="Enter calorie goal">
                            <button type="submit"
                                class="text-white bg-gradient-to-r from-purple-700 to-purple-800 hover:to-purple-900 font-bold py-2 px-4 rounded-r-md">Set</button>
                        </div>
                    </div>
                </form>
                ...
                <div class="flex space-x-4">
                    <a href="#"
                        class="text-white bg-gradient-to-r from-purple-700 to-purple-800 hover:to-purple-900 font-semibold py-2 px-4 rounded">
                        Add Food
                    </a>
                    <a href="#"
